...
export class RedactNoteComponent implements OnInit {
    ...
    ngOnInit() {
        if (this.note) {
            ...
            this.projectPriority = this.note.priority;
            this.projectDifficulty = this.note.difficulty;
    ...
    redactNote() {
        ...
        const updatedNote: Note = {
            ...
            difficulty: this.projectDifficulty // Используем текущее значение difficulty
        };
