...
export class DataService {
  ...
  // getUsers(email: string): Observable<UserData| undefined> {
  //   return this.http.get<UserData[]>('http://localhost:3000/users?email=${email}')
  //     .pipe(map((user: UserData[]) => user[0] ? user[0] : undefined));
  // }
